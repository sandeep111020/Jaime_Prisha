...
public class FavoritesAdapter extends FirebaseRecyclerAdapter<ItemModel, com.example.jaimeprisha.Adapters.FavoritesAdapter.myviewholder>{
    ...
    @NonNull
    @Override
    public com.example.jaimeprisha.Adapters.FavoritesAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favoritesitemslayout, parent, false);

        return new com.example.jaimeprisha.Adapters.FavoritesAdapter.myviewholder(view);
    }
